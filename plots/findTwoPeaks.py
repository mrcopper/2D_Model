...
for i in range(int(sys.argv[2])):
  if(i>99):  file = "DENS"+str(sys.argv[1])+"0"+str(i)+"_1D.dat" 
  if(i>9 and i<99):  file = "DENS"+str(sys.argv[1])+"00"+str(i)+"_1D.dat" 
  if(i<9):  file = "DENS"+str(sys.argv[1])+"000"+str(i)+"_1D.dat" 
  f = open(file)
  l = []
